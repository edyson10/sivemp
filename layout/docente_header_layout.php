...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="../index/indexDocente.php" class="logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span>Registro de informacion</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo constant('URL'); ?>usuario/eps"><i class="fa fa-circle-o"></i>Registro Eps</a></li>
            <li><a href="<?php echo constant('URL'); ?>usuario/arl"><i class="fa fa-circle-o"></i>Registro Arl</a></li>
            <li><a href="<?php echo constant('URL'); ?>usuario/empresa"><i class="fa fa-circle-o"></i>Registro de Empresa</a></li>
            <li><a href="<?php echo constant('URL'); ?>usuario/transportadora"><i class="fa fa-circle-o"></i>Registro de emp transportadora</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="<?php echo constant('URL'); ?>visitas/lista"> <i class="fa fa-circle-o"></i> Registros de Estudiantes</a></li>
               <li><a href="<?php echo constant('URL'); ?>visitas/registroVisita"> <i class="fa fa-circle-o"></i> Registrar Visitas</a></li>
