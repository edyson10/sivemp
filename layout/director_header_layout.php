    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="header">Menu</li>
          ...
          <li class="active">
            <a href="<?php echo constant('URL'); ?>usuario/registroDocente">
               <i class="fa fa-user-plus"></i> <span>Registro Docente</span>
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span>Solicitudes de Visitas</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo constant('URL'); ?>visitas/lista"><i class="fa fa-circle-o"></i>Informacion de Solicitudes</a></li>
